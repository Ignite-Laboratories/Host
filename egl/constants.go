...
const (
	CONTEXT_MAJOR_VERSION                    = 0x3098 // Context major version
	CONTEXT_MINOR_VERSION                    = 0x30FB // Context minor version
	CONTEXT_OPENGL_PROFILE_MASK              = 0x30FD // Profile mask (core/compatibility)
	CONTEXT_OPENGL_CORE_PROFILE_BIT          = 0x0001 // Core profile
	CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT = 0x0002 // Compatibility profile
